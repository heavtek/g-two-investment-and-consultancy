...
const ResetPasswordLink = () =>{
    ...
    <form onSubmit={handleSubmit} class="form-horizontal ">
      ...
      <div className='form-group'>
        ...
        <input type='hidden' name='message' value={`${url_location}/reset-password/${userEmail}`} />
     ...
     :''}
       <button type="submit" class="login-btn" style={{width:'100% !important'}}>Send Rest Password Link </button>
      </form>
        </div>
        </div>
        </div>
